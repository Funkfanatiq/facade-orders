...
# Возможные типы фасадов (смешанный — с подтипами: плоский, фрезерованный, шпон, покраска)
facade_choices = ["фрезерованный", "плоский", "шпон", "покраска", "смешанный"]
...
# Категории прайс-листа: изготовление (плоский, фрезер, шпон), доп, покраска по типам
PRICE_CATEGORIES = [
